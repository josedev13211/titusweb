   const pokemonList = document.getElementById("pokemon-list");
    ...
    function showCompareModal() {
      ...
      const animatedSprite1 = p1.sprites.versions?.['generation-v']?.['black-white']?.animated?.front_default || p1.sprites.front_default;
      const animatedSprite2 = p2.sprites.versions?.['generation-v']?.['black-white']?.animated?.front_default || p2.sprites.front_default;
      ...
      compareModal.querySelector(".compare-modal-content").innerHTML = `
        ...
        <div class="compare-grid">
          <div class="compare-pokemon">
            ...
            <img src="${animatedSprite1}" alt="${p1.name}">
            <h2>${p1.name}</h2>
          ...
          <div class="compare-pokemon">
            ...
            <img src="${animatedSprite2}" alt="${p2.name}">
            <h2>${p2.name}</h2>
    ...
    function createPokemonCard(pokemon) {
      ...
      card.innerHTML = `
        ...
        <img src="${animatedSprite}" 
             alt="${pokemon.name}"
             style="animation-delay: ${Math.random() * 2}s; image-rendering: pixelated;">
        <h3>${pokemon.name}</h3>
